...
# GestorDoc Constitution

Un Sistema de Gestión de Correspondencia y Trámite Documentario para controlar, organizar y rastrear el flujo de documentos en una organización. Esta constitución define las reglas no
...
Este producto es un **Sistema de Gestión de Correspondencia y Trámite Documentario** para organizaciones (públicas o privadas) en Latinoamérica.

- El modelo de datos y los flujos DEBEN reflejar el dominio real de la gestión documental: documentos, expedientes, flujos de aprobación, derivaciones y estados de trámite.
- La interfaz web es el canal principal. Las integraciones (email, mensajería) son un medio para notificar o recibir, no definen la naturaleza del producto.
- Toda feature DEBE servir a los roles del proceso de trámite (Mesa de Partes, Analista, Gerente, Archivo). Cualquier feature que no cumpla esa condición queda FUERA del alcance de v1.

**Rationale**: Un foco vertical explícito en la gestión documental previene que el sistema se convierta en un gestor de archivos genérico, manteniendo el modelo de datos alineado con los procesos de negocio reales y dando un criterio claro para aceptar o rechazar alcance.
...
**Version**: 1.1.0 | **Ratified**: [FECHA_ACTUAL] | **Last Amended**: [FECHA_ACTUAL]
