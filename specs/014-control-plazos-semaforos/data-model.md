# Modelo de Datos y Funciones Helper: Feature 014

## 1. Helper de Semáforo (`src/lib/deadline.utils.ts`)
...
## 2. Resumen de Morosidad para Dashboard (`DashboardKpisWithMora`)

```typescript
export interface DashboardKpisWithMora {
    documentsToday: number;
    pendingDocuments: number;
    totalDocuments: number;
    overdueDocuments: number; // Cantidad de trámites con > 5 días de morosidad
}
```
