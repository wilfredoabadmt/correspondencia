...
function LoginFormContent() {
    ...
    const [selectedRole, setSelectedRole] = useState<'ADMINISTRADOR' | 'OPERADOR'>('ADMINISTRADOR');
    ...
    const handleQuickRoleSelect = (role: 'ADMINISTRADOR' | 'OPERADOR') => {
    ...
    return (
        <div className="w-full max-w-md mx-auto">
            <div className="glass-panel-glow rounded-3xl p-8 sm:p-10 shadow-2xl backdrop-blur-2xl border border-cyan-500/30">
                {/* Header */}
                <div className="text-center space-y-3">
                    ...
                    <h2 className="text-xl font-bold text-white">Portal de Acceso SIGEC</h2>
                    <p className="text-xs text-slate-400">Seleccione su método de ingreso o perfil de demostración</p>
                </div>

                {/* Tabs */}
                <div className="mt-6 p-1 rounded-xl bg-slate-900 border border-slate-800 flex">
                    <button
                        type="button"
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/80 border border-slate-700 text-white text-xs font-medium focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none"
                        >
                    ...
                    {/* Role Fast Selector Chips (If Tab = Roles) */}
                    {activeTab === 'roles' && (
                        <div className="space-y-2 pt-1">
                            <label className="block text-xs font-medium text-slate-300">Seleccionar Rol de Acceso Directo:</label>
                            <div className="grid grid-cols-2 gap-2">
                                ...
                                >
                                    ...
                                    <div className="text-[10px] text-slate-400 mt-1">Correspondencia & Trámites</div>
                                </button>
                                ...
                                >
                                    ...
                                    <div className="text-[10px] text-slate-400 mt-1">Gerencia, Roles & TI</div>
                                </button>
                            </div>
                        </div>
                    )}
                    ...
                    {/* Email Input */}
                    <div>
                        <label className="block text-xs font-medium text-slate-300 mb-1">Correo Electrónico Institucional</label>
                        <input
                            type="email"
                            required
                            value={email}
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/80 border border-slate-700 text-white text-xs font-mono focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none placeholder-slate-600"
                        />
                    </div>
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <span className="text-[10px] text-cyan-400 hover:underline cursor-pointer">¿Olvidó su contraseña?</span>
                        </div>
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/80 border border-slate-700 text-white text-xs font-mono focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none pr-10"
                            />
                            <button
                                type="button"
                ...
                <div className="mt-8 pt-4 border-t border-slate-800/80 text-center space-y-2">
                    <div className="flex items-center justify-center gap-3 text-[11px] text-slate-500 font-mono">
                        <span className="flex items-center gap-1">🔒 TLS 1.3 Encriptado</span>
                        <span>•</span>
                        <span>Multi-Tenant Active</span>
                    </div>
                    <p className="text-[10px] text-slate-600">GestorDoc SIGEC • Conforme a Ley N° 164 y DS 3251 de Gobierno Electrónico</p>
                </div>
            </div>
        </div>
    );
...
export function LoginForm() {
    return (
        <Suspense fallback={
            <div className="w-full max-w-md mx-auto p-8 rounded-3xl glass-panel text-center text-slate-400 text-sm">
